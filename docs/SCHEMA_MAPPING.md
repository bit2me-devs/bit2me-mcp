...
- 12 Wallet & Broker Tools
- 14 Trading Pro Tools
...
> **Note:** These tools return market prices and data used by the Wallet/Broker service, not Pro Trading prices. For Pro Trading market data, see the Pro Trading Tools section.
...
- Array of object
  ...
  - **`paylands_token`** (string) **(required)**: paylands token
  - **`brand`** (string) **(required)**: Card network brand (e.g., "visa", "mastercard")
  - **`country`** (string) **(required)**: country
  - **`holder`** (string) **(required)**: Cardholder name as it appears on the card
  ...
  - **`created_at`** (string) **(required)**: ISO 8601 date/time when the resource was created
    - Format: `date-time`
  - **`verified`** (boolean) **(required)**: true if the card has been verified for payments
  - **`invalid`** (boolean) **(required)**: true if the card has been marked as invalid or expired
...
- Array of object
  ...
  - **`status`** (string) **(required)**: Current order status
    - Possible values: `"pending"`, `"completed"`, `"failed"`, `"cancelled"`, `"unknown"`
...
- Array of object
  ...
  - **`symbol`** (string) **(required)**: Asset symbol in uppercase (e.g., BTC, ETH, EUR)
  - **`balance`** (string) **(required)**: Current balance as string for precision
  - **`strategy`** (string) **(required)**: strategy
  - **`status`** (string) **(required)**: Current order status
    - Possible values: `"open"`, `"filled"`, `"cancelled"`, `"inactive"`
  - **`created_at`** (string) **(required)**: ISO 8601 date/time when the resource was created
    - Format: `date-time`
...
- Array of object
  ...
  - **`created_at`** (string) **(required)**: ISO 8601 date/time when the resource was created
    - Format: `date-time`
  - **`wallet_id`** (string) **(required)**: Unique identifier (UUID) for the Earn wallet
  - **`status`** (string) **(required)**: Current order status
    - Possible values: `"open"`, `"filled"`, `"cancelled"`, `"inactive"`
