...
import { handleConfirmWritePrompt } from "./confirm-write.js";
...
export const prompts: PromptDefinition[] = [
    ...
    {
        name: "confirm_write",
        description: "Teach the two-step WRITE preview: needs_confirmation, then confirm: true.",
        arguments: [
            {
                name: "tool",
                description: "Optional WRITE tool name (snake_case). Omitted → speak generically.",
                required: false,
            },
        ],
    },
...
export function handleGetPrompt(
    ...
    switch (name) {
        ...
        case "loan_health_check":
            ...
            break;
        case "confirm_write":
            text = handleConfirmWritePrompt(args);
            break;
        default:
