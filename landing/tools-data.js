    ...
    },
    {
        ...
        "tools": [
            ...
            },
            {
                ...
                "type": "READ",
                "desc": "Get loan movement history with full details. Returns movements with type (approve, repay, liquidate, interest), nested loan/guarantee objects with fiat values, and LTV tracking. Optional order_id filter. Use to track loan lifecycle events. [PRIVATE]",
                "args": {
                    "order_id": {
                        "type": "string",
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "type": {
                                ...
                                "description": "Movement type: approve (loan created/approved), repay (partial or full payment), liquidate (forced collateral liquidation), interest (interest charge)"
                            },
                            "status": {
                                "type": "string",
                                "enum": [
                                ...
                                "description": "Movement status: pending (processing), completed (finished successfully), failed (operation failed)"
                            },
                            "loan": {
                                "type": "object",
                                "description": "Loan details at time of movement",
                                "properties": {
                                    "amount": {
                                        "type": "string",
                                        "description": "Loan amount (as string for precision)"
                                    },
                                    "symbol": {
                                        "type": "string",
                                        "description": "Loan currency symbol (e.g., EUR, EURR, USDC)"
                                    },
                                    "amount_fiat": {
                                        "type": "string",
                                        "description": "Loan value in EUR (2 decimals)"
                                    }
                                },
                                "required": [
                                    "amount",
                            ...
                            "guarantee": {
                                "type": "object",
                                "description": "Collateral details at time of movement",
                                "properties": {
                                    "amount": {
                                        "type": "string",
                                        "description": "Collateral amount (full precision for crypto)"
                                    },
                                    "symbol": {
                                        "type": "string",
                                        "description": "Collateral asset symbol (e.g., BTC, ETH)"
                                    },
                                    "amount_fiat": {
                                        "type": "string",
                                        "description": "Collateral value in EUR (2 decimals)"
                                    }
                                },
                                "required": [
                                    "amount",
                            ...
                            "ltv": {
                                "type": "string",
                                "description": "Loan-to-Value ratio after this movement (e.g., '0.50' = 50%). Lower is safer."
                            },
                            "previous_ltv": {
                                "type": "string",
                            ...
                            "created_at": {
                                "type": "string",
                                "format": "date-time",
                                "description": "ISO 8601 timestamp when movement was created"
                            }
                        },
                        "required": [
                            "id",
